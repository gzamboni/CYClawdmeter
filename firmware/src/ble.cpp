...
#define DEVICE_NAME "CYClawdmeter"
...
static void start_advertising() {
    ...
    //   flags (3) + appearance (4) + HID service 0x1812 (4) + name "CYClawdmeter" (14)
    //   = 25 bytes. macOS Bluetooth Settings only surfaces BLE-only devices
