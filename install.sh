...
echo "and connect to CYClawdmeter over Bluetooth Low Energy."
echo ""
echo "First-time Bluetooth pairing:"
echo "  1. Power on CYClawdmeter"
echo "  2. Run: bluetoothctl scan le"
echo "  3. Find 'CYClawdmeter' and note the MAC address"
